...
const SignUp = () => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async data => {
        console.log(data)
        const res = await axios.post(`${SV_URL}/user/signup`, data)
        if (res.data.success) {
            navigate('/login')
        }else{
            ...
            <div className="box w-3/5 h-[600px] bg-red-300 flex rounded-lg shadow-md">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-4">
                    <form className='flex items-center justify-center flex-col w-full' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-6 w-4/5">
                            ...
                            <input
                                ...
                                type="password" id="cfpassword" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                        </div>
                    ...
                    <div className="flex gap-3 items-center justify-center">
                        ...
                        <span className='font-semibold hover:text-blue-500 cursor-pointer' onClick={() => navigate('/login')}>Log in</span>
                    </div>
